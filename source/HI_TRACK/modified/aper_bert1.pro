pro aper_bert1,image,xc,yc,mags,errap,sky,skyerr,phpadu,apr,skyrad,badpix, $
  ...
  minsky = 2   ;Smallest number of pixels from which the sky may be determined
  ...
  for i = 0L, Nstars-1 do begin           ;Compute magnitudes for each star
    ...
    if Ng GT 0 then begin
      apmag[g] = apmag[g] - abs(skymod)*area[g]  ;Subtract sky from the integrated brightnesses
      ; changed from 'apmag[g] = apmag[g] - skymod*area[g]'
