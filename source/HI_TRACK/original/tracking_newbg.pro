...
;CD, '/net/xun0/export/home/lnx/gemma/data1/gemma/HI_TRACK'
CD, current=dir
...
datapath = file_search(filepath('*L2.sav',SUBDIR=['HI_TRACK','data','track_in_a_test'],ROOT_DIR=dir));specifically for cluster


; Gets the catalogue information
;catalogue_files=filepath('radec_mag.sav',SUBDIR=['resource'],ROOT_DIR=dir)
catalogue_files=filepath('radec_mag.sav',SUBDIR=['HI_TRACK','resource'],ROOT_DIR=dir) ;the actual complete catalogue
