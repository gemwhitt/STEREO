...
;-
;
PRO sort_stars2,star_xy,star_int,star_err,bkgd,bkgd_err,imstars,mag,errap,sky,skyerr,count
;sort_stars2,star_mag,star_radec,star_xy,star_int,star_err,bkgd,bkgd_err,vfov,vfov2,imstars,mag,errap,sky,skyerr,count
...
;IF (size(star_radec))[0] eq 2 THEN counter=1 else counter = ssz[2]  ; original
counter = ssz[1]  ; change this for test
